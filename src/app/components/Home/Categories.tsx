...
const Categories = () => {
  ...
  return (
    ...
    <>
       <div className=" top-[1800px] flex md:flex-col sm:flex sm:flex-col  ">
            <div className="volkhov-regular font-[400] text-[40px] flex justify-center items-center mt-[40px]  ">
            New Arrivals
            </div>
            <div className="w-[600px] h-[100px] poppins-thin flex flex-wrap  items-center top-[84px] text-gray-600 text-[16px] mt-[30px] ml-[420px] md:w-[600px] md:h-[100px] md:poppins-thin md:flex md:flex-wrap  md:items-center md:top-[84px] md:text-gray-600 md:text-[16px] md:mt-[30px] md:ml-[420px] sm:w-[340px] sm:h-[100px] sm:poppins-thin sm:flex sm:flex-wrap  sm:items-center sm:top-[184px] sm:text-gray-600 sm:text-[16px]  sm:ml-[50px] ">
            ...
            <div className="md:w-[1200px] md:h-[900px] md:ml-[40px]  md:flex md:flex-wrap md:gap-[30px] md:mt-[20px] md:justify-center">
                <div className="w-[280px] h-[330px] flex flex-col  shadow-2xl rounded-lg mt-[20px] md:ml-[20px] gap-[5px] sm:ml-[50px]">
                ...
                <div className="w-[280px] h-[330px] flex flex-col  shadow-xl rounded-lg mt-[20px] md:ml-[20px] gap-[5px] sm:ml-[50px]">
                ...
                <div className="w-[280px] h-[330px] flex flex-col  shadow-2xl rounded-lg mt-[20px] md:ml-[20px] sm:ml-[50px] gap-[5px]">
